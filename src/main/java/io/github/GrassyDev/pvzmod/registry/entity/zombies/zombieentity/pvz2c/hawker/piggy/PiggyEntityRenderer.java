...
public class PiggyEntityRenderer extends GeoEntityRenderer<PiggyEntity> {
	...
	@Override
	public void render(GeoModel model, PiggyEntity animatable, float partialTick, RenderLayer type, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
