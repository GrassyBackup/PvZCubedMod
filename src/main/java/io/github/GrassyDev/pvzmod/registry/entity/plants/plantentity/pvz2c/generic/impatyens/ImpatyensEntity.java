...
public class ImpatyensEntity extends PlantEntity implements IAnimatable, RangedAttackMob {
	...
	private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
		if (this.isFiring) {
			event.getController().setAnimation(new AnimationBuilder().playOnce("impatyens.shoot"));
		} else {
			event.getController().setAnimation(new AnimationBuilder().loop("impatyens.idle"));
		}
