...
public class CoffeeBeanEntity extends PlantEntity implements IAnimatable {
	...
	private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
		...
		event.getController().setAnimation(new AnimationBuilder().loop("coffeebean.idle"));
	...
	public ItemStack getPickBlockStack() {
		return ModItems.COFFEEBEAN_SEED_PACKET.getDefaultStack();
	}
