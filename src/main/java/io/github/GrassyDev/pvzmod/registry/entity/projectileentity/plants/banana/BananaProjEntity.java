package io.github.GrassyDev.pvzmod.registry.entity.projectileentity.plants.banana;
...
public class BananaProjEntity extends PvZProjectileEntity implements IAnimatable {
	...
	public void createBananaTile(BlockPos blockPos){
		if (this.world instanceof ServerWorld serverWorld) {
			...
			if (tileCheck.isEmpty()) {
				BananaTile tile = (BananaTile) PvZEntity.BANANAPEEL.create(world);
