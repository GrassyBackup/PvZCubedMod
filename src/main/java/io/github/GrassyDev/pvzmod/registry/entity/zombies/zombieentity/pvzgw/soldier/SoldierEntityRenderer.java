 ...
 */
public class SoldierEntityRenderer extends GeoEntityRenderer<SoldierEntity> {

    public SoldierEntityRenderer(EntityRendererFactory.Context ctx) {
		super(ctx, new SoldierEntityModel());
        this.shadowRadius = 0.7F; //change 0.7 to the desired shadow size.
    }


	@Override
	public void render(GeoModel model, SoldierEntity animatable, float partialTick, RenderLayer type, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
