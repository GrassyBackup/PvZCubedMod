...
public class FlagFutureEntity extends SummonerEntity implements IAnimatable {
	...
	public boolean damage(DamageSource source, float amount) {
		if (!super.damage(source, amount)) {
			...
			if (this.getRecentDamageSource() == PvZCubed.HYPNO_DAMAGE && !(this.getHypno())) {
				...
				FlagFutureEntity hypnotizedZombie = (FlagFutureEntity) hypnoType.create(world);
    ...
    class summonZombieGoal extends CastSpellGoal {
        ...
        protected void castSpell() {
            ...
            ServerWorld serverWorld = (ServerWorld) FlagFutureEntity.this.world;
            for(int b = 0; b < 1; ++b) { // 1 Screendoor
				...
				FutureZombieEntity screendoorEntity = (FutureZombieEntity) screen.create(FlagFutureEntity.this.world);
				screendoorEntity.refreshPositionAndAngles(blockPos, 0.0F, 0.0F);
				screendoorEntity.initialize(serverWorld, FlagFutureEntity.this.world.getLocalDifficulty(blockPos), SpawnReason.MOB_SUMMONED, (EntityData) null, (NbtCompound) null);
            ...
            for(int p = 0; p < 3; ++p) { // 3 Conehead
				...
				FutureZombieEntity coneheadEntity = (FutureZombieEntity) cone.create(FlagFutureEntity.this.world);
                coneheadEntity.refreshPositionAndAngles(blockPos, 0.0F, 0.0F);
                coneheadEntity.initialize(serverWorld, FlagFutureEntity.this.world.getLocalDifficulty(blockPos), SpawnReason.MOB_SUMMONED, (EntityData)null, (NbtCompound)null);
            ...
            for(int d = 0; d < 2; ++d) { // 2 Buckethead
				...
				FutureZombieEntity bucketheadEntity = (FutureZombieEntity) bucket.create(FlagFutureEntity.this.world);
                bucketheadEntity.refreshPositionAndAngles(blockPos, 0.0F, 0.0F);
                bucketheadEntity.initialize(serverWorld, FlagFutureEntity.this.world.getLocalDifficulty(blockPos), SpawnReason.MOB_SUMMONED, (EntityData)null, (NbtCompound)null);
            ...
            for(int t = 0; t < 6; ++t) { // 6 Browncoat
				...
				FutureZombieEntity browncoatEntity = (FutureZombieEntity) coat.create(FlagFutureEntity.this.world);
                browncoatEntity.refreshPositionAndAngles(blockPos, 0.0F, 0.0F);
                browncoatEntity.initialize(serverWorld, FlagFutureEntity.this.world.getLocalDifficulty(blockPos), SpawnReason.MOB_SUMMONED, (EntityData)null, (NbtCompound)null);
