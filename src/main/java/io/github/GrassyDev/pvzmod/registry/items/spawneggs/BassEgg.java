...
public class BassEgg extends SeedItem {
    public BassEgg(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        BlockPos blockPos2 = itemPlacementContext.getBlockPos();
		BlockPos blockPos = new BlockPos(blockPos2.getX(), blockPos2.getY() + 3, blockPos2.getZ());
