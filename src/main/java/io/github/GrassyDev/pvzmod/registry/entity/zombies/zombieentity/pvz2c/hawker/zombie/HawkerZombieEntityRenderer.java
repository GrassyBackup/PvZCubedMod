package io.github.GrassyDev.pvzmod.registry.entity.zombies.zombieentity.pvz2c.hawker.zombie;
 ...
 */
public class HawkerZombieEntityRenderer extends GeoEntityRenderer<HawkerZombieEntity> {

    public HawkerZombieEntityRenderer(EntityRendererFactory.Context ctx) {
		super(ctx, new HawkerZombieEntityModel());
        this.shadowRadius = 0.7F; //change 0.7 to the desired shadow size.
    }

	@Override
	public void render(GeoModel model, HawkerZombieEntity animatable, float partialTick, RenderLayer type, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
