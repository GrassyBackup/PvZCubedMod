...
public class RockObstacleEntityRenderer extends GeoEntityRenderer<RockObstacleEntity> {
	...
	@Override
	public void render(GeoModel model, RockObstacleEntity animatable, float partialTick, RenderLayer type, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
