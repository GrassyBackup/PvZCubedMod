...
public class GambleshroomEntity extends PlantEntity implements IAnimatable, RangedAttackMob {
    ...
    public GambleshroomEntity(EntityType<? extends GambleshroomEntity> entityType, World world) {
	...
	private static final TrackedData<Boolean> DATA_ID_TYPE_VARIANT =
			DataTracker.registerData(GambleshroomEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
	...
	public void setHat(GambleshroomEntity.MagicHat magicHat) {
	...
	protected void initGoals() {
		this.goalSelector.add(1, new GambleshroomEntity.FireBeamGoal(this));
	}
	...
	static class FireBeamGoal extends Goal {
		private final GambleshroomEntity plantEntity;
		...
		public FireBeamGoal(GambleshroomEntity plantEntity) {
