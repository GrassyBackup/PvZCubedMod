 ...
 */
public class SpeakerVehicleEntityRenderer extends GeoEntityRenderer<SpeakerVehicleEntity> {

    public SpeakerVehicleEntityRenderer(EntityRendererFactory.Context ctx) {
		super(ctx, new SpeakerVehicleEntityModel());
        this.shadowRadius = 0.9F; //change 0.7 to the desired shadow size.
    }

	@Override
	public void render(GeoModel model, SpeakerVehicleEntity animatable, float partialTick, RenderLayer type, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
