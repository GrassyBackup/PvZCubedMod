...
public class GhostpepperEntity extends PlantEntity implements IAnimatable {
	...
	private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
		if (this.exploding) {
			...
			event.getController().setAnimation(new AnimationBuilder().loop("ghostpepper.attack"));
		}
		else {
			event.getController().setAnimation(new AnimationBuilder().loop("ghostpepper.idle"));
		}
