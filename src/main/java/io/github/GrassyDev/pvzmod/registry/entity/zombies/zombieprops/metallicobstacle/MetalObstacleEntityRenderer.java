...
public class MetalObstacleEntityRenderer extends GeoEntityRenderer<MetalObstacleEntity> {
	...
	@Override
	public void render(GeoModel model, MetalObstacleEntity animatable, float partialTick, RenderLayer type, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
