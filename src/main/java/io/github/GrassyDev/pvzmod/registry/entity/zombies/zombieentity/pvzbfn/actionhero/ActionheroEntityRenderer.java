 ...
 */
public class ActionheroEntityRenderer extends GeoEntityRenderer<ActionheroEntity> {

    public ActionheroEntityRenderer(EntityRendererFactory.Context ctx) {
		super(ctx, new ActionheroEntityModel());
        this.shadowRadius = 0.7F; //change 0.7 to the desired shadow size.
    }

	@Override
	public void render(GeoModel model, ActionheroEntity animatable, float partialTick, RenderLayer type, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
