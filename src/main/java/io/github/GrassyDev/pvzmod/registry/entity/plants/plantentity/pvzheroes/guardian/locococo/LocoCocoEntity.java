...
public class LocoCocoEntity extends PlantEntity implements IAnimatable, RangedAttackMob {
	...
	private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
		...
		if (this.isFiring) {
			event.getController().setAnimation(new AnimationBuilder().playOnce("locococo.slap"));
		} else {
			event.getController().setAnimation(new AnimationBuilder().loop("locococo.idle"));
		}
