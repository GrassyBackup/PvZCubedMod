...
public class SargeantEntityRenderer extends GeoEntityRenderer<SargeantEntity> {
	...
	@Override
	public void render(GeoModel model, SargeantEntity animatable, float partialTick, RenderLayer type, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
