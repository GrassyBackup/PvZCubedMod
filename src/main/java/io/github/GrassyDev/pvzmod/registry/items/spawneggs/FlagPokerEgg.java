    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
		...
		if (world.isSpaceEmpty((Entity)null, box) && world instanceof ServerWorld serverWorld) {
				 double random = Math.random();
                    FlagPokerEntity flagzombieEntity = (FlagPokerEntity) PvZEntity.FLAGPOKER.create(serverWorld, itemStack.getNbt(), (Text) null, context.getPlayer(), blockPos, SpawnReason.SPAWN_EGG, true, true);
