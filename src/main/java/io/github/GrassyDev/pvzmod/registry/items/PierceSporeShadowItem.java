...
public class PierceSporeShadowItem extends Item {
    public PierceSporeShadowItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
			PierceSporeEntity proj = new PierceSporeEntity(PvZEntity.PIERCESPORE, world);
